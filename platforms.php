            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3">
                        <?php _e('platforms_ref_desc'); ?>
                        <a href="https://github.com/ourongxing/newsnow/tree/main/server/sources" target="_blank"><?php _e('newsnow_source_code'); ?></a><?php _e('find_more_platforms'); ?>
                    </p>
